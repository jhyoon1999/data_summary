...
tab1, tab2 = st.tabs(['소개 및 프로젝트', '경력 및 기술스택'])
...
with tab1 : 
    ...
    with st.expander("제주도 관광지 추천 웹서비스 개발") :
        # 빨간색으로 출력할 텍스트
        text = "<span style='color:red;'>keywords :#데이터 분석 #머신러닝 #추천시스템 #앱</span>"
        # HTML 태그를 사용하여 텍스트 출력
        st.markdown(text, unsafe_allow_html=True)
        
        st.markdown("- 구분 : 개인 프로젝트")
        st.markdown("- 참여기간 : 2023.09 ~ 2023.11 (3개월)")
        st.markdown("- 프로젝트 요약 : AI 기반 개인 맞춤형 제주도 관광지 추천 웹서비스 개발")
        st.markdown("- 담당 업무 : 데이터 수집/가공, 데이터 분석, 추천시스템 개발, API 개발")
    ...
    with st.expander("AI 기반 리서치 정성(Qualitative)데이터 분석 플랫폼 구축") :
        # 빨간색으로 출력할 텍스트
        text = "<span style='color:red;'>keywords :#텍스트 데이터 #라벨 체계 #실시간 대시보드</span>"
        # HTML 태그를 사용하여 텍스트 출력
        st.markdown(text, unsafe_allow_html=True)
    ...
    with st.expander("국내 의류산업 현황분석 및 분석앱 개발") :
        # 빨간색으로 출력할 텍스트
        text = "<span style='color:red;'>keywords :#기업 데이터 #데이터 분석 #분석 앱</span>"
        # HTML 태그를 사용하여 텍스트 출력
        st.markdown(text, unsafe_allow_html=True)
    ...
    with st.expander("ML을 활용한 종합 적응적 인지검사 시스템 ACT 개발") :
        # 빨간색으로 출력할 텍스트
        text = "<span style='color:red;'>keywords :#적성검사 #적응적 검사 #머신러닝</span>"
        # HTML 태그를 사용하여 텍스트 출력
        st.markdown(text, unsafe_allow_html=True)
